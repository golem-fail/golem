...
mod tests {
    ...
    async fn emit_sends_event_receivable_via_subscribe() {
        ...
        sender.emit(
            ...
            EventKind::FlowStarted { flow_name: "login".into() },
        );
    ...
    async fn sequence_numbers_increment_monotonically() {
        ...
        sender.emit(dev.clone(), EventKind::FlowStarted { flow_name: "a".into() });
    ...
    async fn multiple_subscribers_each_get_all_events() {
        ...
        sender.emit(
            DeviceId("dev".into()),
            EventKind::FlowStarted { flow_name: "f1".into() },
        );
        sender.emit(
            DeviceId("dev".into()),
    ...
    async fn device_id_is_correctly_tagged_on_events() {
        ...
        sender.emit(
            ...
            EventKind::FlowStarted { flow_name: "test".into() },
        );
        sender.emit(
